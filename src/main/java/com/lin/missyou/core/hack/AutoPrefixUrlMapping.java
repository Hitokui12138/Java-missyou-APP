...
/**
 * RequestMappingHandlerMapping 这个类可以专门处理所有打上`@Requestmapping`的控制器
 */
public class AutoPrefixUrlMapping extends RequestMappingHandlerMapping {

    @Value("${missyou.api-package}") //com.lin.missyou.api
    ...
    /**
     * 修改前缀
     * @param handlerType 参考getMappingForMethod()的参数
     * @return
     */
